...
public abstract class AbstractIdentifiableDomainObject<ID extends Serializable>
	...
	/**
	 * @see com.acme.orderplacement.domain.support.IdentifiableDomainObject#getId()
	 */
	public ID getId() {
	...
	/**
	 * @see com.acme.orderplacement.domain.support.IdentifiableDomainObject#setId(java.io.Serializable)
	 */
