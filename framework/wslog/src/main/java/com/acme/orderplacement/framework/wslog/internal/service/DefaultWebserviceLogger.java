 ...
 * 
 */
package com.acme.orderplacement.framework.wslog.internal.service;
...
import com.acme.orderplacement.framework.wslog.internal.domain.WebserviceOperation;
...
import com.acme.orderplacement.framework.wslog.service.WebserviceResponseDto;
...
public class DefaultWebserviceLogger implements WebserviceLogger {
	...
	/**
	 * @see com.acme.orderplacement.framework.wslog.service.WebserviceLogger#logWebserviceRequest(com.acme.orderplacement.framework.wslog.service.WebserviceRequestDto)
	 */
	...
	/**
	 * @see com.acme.orderplacement.framework.wslog.service.WebserviceLogger#logWebserviceResponse(com.acme.orderplacement.framework.wslog.service.WebserviceResponseDto)
	 */
	@Transactional(readOnly = false, propagation = Propagation.REQUIRES_NEW)
