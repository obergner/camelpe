...
@NamedQueries( { @NamedQuery(name = WebserviceOperation.Queries.BY_NAME, query = "from com.acme.orderplacement.framework.wslog.internal.domain.WebserviceOperation wso where wso.name = :name") })
