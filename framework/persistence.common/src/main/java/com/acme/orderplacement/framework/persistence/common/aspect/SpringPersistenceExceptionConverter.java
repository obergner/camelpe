...
public class SpringPersistenceExceptionConverter {
	 ...
	 * {@link com.acme.orderplacement.framework.persistence.common.jpa.AbstractJpaDao
	 * <code>AbstractJpaDao</code>}.
	 */
	@Pointcut("target(com.acme.orderplacement.framework.persistence.common.jpa.AbstractJpaDao)")
	 ...
	 * <code>AbstractJpaDao</code>}.
	 */
	@Pointcut("com.acme.orderplacement.framework.persistence.common.meta.PersistenceLayer.persistenceOperations() && springBasedDaos()")
