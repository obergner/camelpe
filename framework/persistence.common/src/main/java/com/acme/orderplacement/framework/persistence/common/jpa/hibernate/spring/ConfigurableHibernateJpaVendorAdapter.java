 ...
 * 
 */
package com.acme.orderplacement.framework.persistence.common.jpa.hibernate.spring;
...
import com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean;
...
public class ConfigurableHibernateJpaVendorAdapter extends
	...
	// -------------------------------------------------------------------------
	// com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean
	// -------------------------------------------------------------------------

	/**
	 * @param postDeleteEventListeners
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostDeleteEventListeners(java.util.List)
	 */
	 ...
	 * @param postDeleteEventListeners
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostDeleteEventListeners(org.hibernate.event.PostDeleteEventListener[])
	 */
	public void setAdditionalPostDeleteEventListeners(
	 ...
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostInsertEventListeners(java.util.List)
	 */
	 ...
	 * @param postInsertEventListeners
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostInsertEventListeners(org.hibernate.event.PostInsertEventListener[])
	 */
	public void setAdditionalPostInsertEventListeners(
	 ...
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostUpdateEventListeners(java.util.List)
	 */
	 ...
	 * @param postUpdateEventListeners
	 * @throws IllegalArgumentException
	 * @see com.acme.orderplacement.framework.persistence.common.jpa.hibernate.ConfigurableHibernatePersistenceProviderBean#setAdditionalPostUpdateEventListeners(org.hibernate.event.PostUpdateEventListener[])
	 */
	public void setAdditionalPostUpdateEventListeners(
