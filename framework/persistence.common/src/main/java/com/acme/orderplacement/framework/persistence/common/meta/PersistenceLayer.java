 ...
 * 
 */
package com.acme.orderplacement.framework.persistence.common.meta;
...
public final class PersistenceLayer {
	 ...
	 */
	@Pointcut("@annotation(com.acme.orderplacement.framework.persistence.common.meta.annotation.ReadOnlyPersistenceOperation)")
	 ...
	 * state in our database.
	 */
	@Pointcut("@annotation(com.acme.orderplacement.framework.persistence.common.meta.annotation.StateModifyingPersistenceOperation)")
