...
/**
 * <p>
 * Test {@link ItemCreatedEventJaxbToTargetTransformer}.
 * </p>
 * 
 * @author <a href="mailto:olaf.bergner@saxsys.de">Olaf Bergner</a>
 * 
 */
public class ItemCreatedEventJaxbToTargetTransformerTest {
	...
	private final ItemCreatedEventJaxbToTargetTransformer classUnderTest = new ItemCreatedEventJaxbToTargetTransformer();
	...
	public final void transformFromJaxbShouldProduceValidTargetObject() {
		final ItemDto itemDto = this.classUnderTest
				.transformFromJaxb(createValidJaxbItemCreatedEvent());
