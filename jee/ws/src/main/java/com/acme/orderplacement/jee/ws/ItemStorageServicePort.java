 ...
 * 
 */
package com.acme.orderplacement.jee.ws;
...
public class ItemStorageServicePort implements ItemStorageServicePortType {
	...
	/**
	 * @see com.acme.orderplacement.jee.ws.api.ItemStorageServicePortType#registerItem
	 *      (com.acme.orderplacement.jee.ws.api.RegisterItemRequest)
	 */
