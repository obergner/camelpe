 ...
 * 
 */
public final class ServiceLayerSpecificSpringBeanAutowiringInterceptor extends
		SpringBeanAutowiringInterceptor {

	/**
	 * Our <code>ApplicationContext</code>'s location on the classpath.
	 */
	private static final String RESOURCE_LOCATION = "classpath:META-INF/spring/ejb.beanRefContext.xml";
	 ...
	 */
	private static final String BEAN_FACTORY_LOCATOR_KEY = "com.acme.orderplacement.jee.serviceComponentFactory";
