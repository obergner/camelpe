...
public class SampleItemImportConfig implements ItemImportConfig {
	...
	/**
	 * @see com.acme.orderplacement.jee.item.itemimport.config.ItemImportConfig#activeMQComponent()
	 */
	...
	/**
	 * @see com.acme.orderplacement.jee.item.itemimport.config.ItemImportConfig#itemStorageService()
	 */
