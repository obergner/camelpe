...
@NamedQueries( { @NamedQuery(name = WebserviceOperation.Queries.BY_NAME, query = "from com.acme.orderplacement.jee.framework.wslog.service.internal.domain.WebserviceOperation wso where wso.name = :name") })
