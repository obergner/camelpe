...
import com.acme.orderplacement.jee.framework.camelpe.configuration_samples.SampleClassResolver;
...
public class CdiCamelContextConfigurationInContainerTest {
	...
	public static JavaArchive createTestArchive() {
		final JavaArchive testModule = ShrinkWrap.create(JavaArchive.class,
				"test.jar").addClass(CdiCamelContextConfiguration.class)
	...
	/**
	 * Test method for
	 * {@link com.acme.orderplacement.jee.framework.camelpe.CdiCamelContextConfiguration#configure(org.apache.camel.CamelContext)}
	 * .
	 */
	@Test
