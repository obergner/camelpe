...
import com.acme.orderplacement.jee.framework.camelpe.routes_samples.FirstRouteBuilder;
...
public class RoutesDiscoveryInContainerTest {
	...
	public static JavaArchive createTestArchive() {
		final JavaArchive testModule = ShrinkWrap.create(JavaArchive.class,
				"test.jar").addClass(RoutesDiscovery.class).addPackages(false,
				FirstRouteBuilder.class.getPackage()).addManifestResource(
	...
	/**
	 * Test method for
	 * {@link com.acme.orderplacement.jee.framework.camelpe.RoutesDiscovery#registerDiscoveredRoutesIn(org.apache.camel.CamelContext)}
	 * .
	 * 
	 * @throws Exception
	 */
